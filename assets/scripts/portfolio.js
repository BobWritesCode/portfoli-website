...
export const portfolio = [
    {
        ...
        description: "Squad Up, uses React to create a  user interfaces component built application. This application uses API communication to provide live content.",
